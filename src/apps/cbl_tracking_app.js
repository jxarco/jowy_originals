...
class CblTrackingApp {
            ...
            LX.addDropdownMenu(event.target, [
                {
                    ...
                    icon: "ExternalLink",
                    callback: () => this.openWooCommerceOrders()
                },
                {
    ...
    async markOrderAsCompleted(tableWidget, index, wcc, orderNumber) {
        const core = this.core;
        const dialogClosable = new LX.Dialog("Completar Pedido", dialogPanel => {
            ...
            dialogPanel.addButton(null, "Continuar", async () => {
                ...
                tableWidget.data.body[index][tableWidget.data.head.indexOf("ESTADO")] = core.orderStatus[newStatus]
                tableWidget.refresh();
                ...
                invoicePanel.addButton(null, "Facturar", () => {
                    const dialogClosable = new LX.Dialog("Facturar en WooCommerce", dialogPanel => {
                        ...
                        dialogPanel.addButton(null, "Continuar", async () => {
                            ...
                            LX.toast("Proceso completado", "✅ Pulsa <span>Ver</span> para comprobar los datos en la plataforma.", {
                                timeout: 5000, position: "top-left", action: {
                                    name: "Ver",
                                    callback: () => {
    ...
    openWooCommerceOrders() {
        const core = this.core;
        const allRows = core.data[core.compName].list;
    ...
    open(params) {
        ...
        this.core.setHeaderTitle("Gestión de pedidos: <i>CBL</i>", "Arrastra un <strong>.xlsx</strong> aquí para cargar un nuevo listado de envíos.", "FileText");
