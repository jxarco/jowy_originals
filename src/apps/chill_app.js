...
class ChillApp {
    constructor(core) {
        ...
        const panel = new LX.Panel({ height: 'auto', className: 'absolute bg-none border-none p-4 flex flex-col gap-2' });
        ...
        panel.addButton(null, 'Click here', (v) => {
            ...
            const cont = LX.makeElement('div', 'relative w-full', '', panel);
