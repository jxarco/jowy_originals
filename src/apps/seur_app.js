...
class SeurApp {
    ...
    exportSEUR(ignoreErrors = false, sheinData) {
        ...
        const filename = `SEUR_${core.tool.substring(0, core.tool.indexOf("-")).toUpperCase()}_${todayStringDate}.xlsx`;
    ...
    open(params) {
        ...
        this.core.setHeaderTitle(`Envíos SEUR: <i>${params}</i>`, "Arrastra un <strong>.xlsx</strong> aquí para cargar un nuevo listado de envíos.", "Truck");
