...
const core = {
    ...
    {
        const id = [ Utils.removeWhiteSpaces( platform ), country, year ].join( '_' );
    ...
    getAgentCode( platform, year )
    {
        ...
        const id = Utils.removeWhiteSpaces( platform );
        ...
        },
        {
            ...
            submenu: [
                ...
                { name: 'Mirakl', submenu: [
                    ...
                    { name: 'Leroy Merlin', callback: ( v, e ) => core.openApp( core.leroyMerlinApp ), icon: 'LeroyMerlin' },
                    { name: 'Sprinter', callback: ( v, e ) => core.openApp( core.sprinterApp ), icon: 'Sprinter' },
                    { name: 'Planeta Huerto', callback: ( v, e ) => core.openApp( core.planetaHuertoApp ), icon: 'Globe' },
                    { name: 'Worten', callback: ( v, e ) => core.openApp( core.wortenApp ), icon: 'Worten' },
                    { name: 'MediaMarkt', callback: ( v, e ) => core.openApp( core.mediamarktApp ), icon: 'MediaMarkt' },
                    null,
